 ...
 * @author User
 */
public class PatientDataViewForm extends javax.swing.JFrame {

    /**
     * Creates new form PatientDataViewForm
     */
    ...
    private void initComponents() {
        ...
        familydoctorPUEntityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("familydoctorPU").createEntityManager();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientDataViewForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientDataViewForm().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.persistence.EntityManager familydoctorPUEntityManager;
